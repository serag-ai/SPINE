...
from LaMed.src.model.language_model import LamedLlamaForCausalLM, LamedPhi3ForCausalLM,LamedGemma2ForCausalLM
...
class ModelArguments:
    ...
    model_name_or_path: Optional[str] = field(
        ...
        metadata={
            "help": "Path to the LLM or MLLM. microsoft/Phi-3-mini-4k-instruct, llama-2-7b-chat, google/gemma-2-2b-it"
        },
    )
    model_type: Optional[str] = field(default=None, metadata={"help": "llama2, phi3, gemma2"})

    model_with_lora: Optional[str] = field(
        default="/acfs-home/hoh4002/serag_AI_lab/users/hoh4002/eICU/Spinal_cord/src/output/model_with_lora_3.bin"
    )
    ...
    pretrain_mm_mlp_adapter: Optional[str] = field(
        default="/acfs-home/hoh4002/serag_AI_lab/users/hoh4002/eICU/Spinal_cord/src/mm_projector.bin",
    ...
    pretrain_vision_model: str = field(
        default="/acfs-home/hoh4002/serag_AI_lab/users/hoh4002/eICU/Spinal_cord/src/pretrained_ViT.bin",
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    output_dir: str = "./LaMed/output/LaMed-Phi3-4B-finetune-0000-S1-composite-grok-fold-5/hf/"
...
def main():
    ...
    if "llama2" in model_args.model_type:
    ...
    elif "gemma2" in model_args.model_type:
        model = LamedGemma2ForCausalLM.from_pretrained(
            model_args.model_name_or_path, cache_dir=training_args.cache_dir
        )
    else:
